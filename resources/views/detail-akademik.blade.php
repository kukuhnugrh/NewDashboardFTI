...
@section('title', 'Detail Akademik Mahasiswa')
@section('content')
<div class="content">
    <div class="row ms-3">
        <div class="col-md-12">
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-12 d-flex justify-content-center">
                            <a href="/evaluasi/dataPribadi" id="dataPribadibtn" value="dataPribadi" type="button" class="btn {{ (session()->get('detailTab') == 'dataPribadi' ) ? 'btn-primary' : 'btn-outline-primary' }} w-100">Data Pribadi</a>
                            <a href="#" id="dataAkademikbtn" value="dataAkademik" type="button" class="btn {{ (session()->get('detailTab') == 'dataAkademik' ) ? 'btn-primary' : 'btn-outline-primary' }} w-100">Data Akademik</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
